...
BATCH_SIZE = 128
NUM_EPOCHS = 1 # Adjust based on time available
...
def train():
    ...
    # Using ImageFolder since manual downloads lack the CelebA split .txt files natively
    dataset = datasets.ImageFolder(root="dataset/celeba/", transform=transform)
